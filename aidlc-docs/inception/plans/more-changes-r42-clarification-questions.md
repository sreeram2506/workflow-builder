# More Changes R42 — Clarification Questions (change request)

**Context**: You requested changes after R41 (Repeater glyph shape / stroke width).  
...
[Answer]: A — decrease the width of arrows in repeater it should match the width of condition arrows
...
```text
- Repeater arrow stroke should match Condition glyph stroke width (2.4)
```
