# More Changes R40 — Clarification Questions (change request)

**Context**: You requested changes after R39 (Repeater dual sync arrows; theme colors kept).  
...
A) **Repeater** (dual arrows / size / center / tips)
...
[Answer]: keep some gaps between the edges of two arrows
