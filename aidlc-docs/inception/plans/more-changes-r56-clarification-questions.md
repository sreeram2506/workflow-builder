# More Changes R56 — Clarification Questions (change request)

**Context**: You requested changes after R55 (canvas bar Route button removed).  
...
```text
1.why for condition only if i drag connector on top and bottom connectors not connecting
```
