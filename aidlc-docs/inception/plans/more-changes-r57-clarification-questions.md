# More Changes R57 — Clarification Questions (change request)

**Context**: You requested more changes after R56 (Condition top/bottom connector snap fixed).  
...
```text
we dont need blank agent in nodes library 
