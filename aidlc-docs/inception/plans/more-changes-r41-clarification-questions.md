# More Changes R41 — Clarification Questions (change request)

**Context**: You requested changes after R40 (gaps between Repeater dual arrows).  
...
A) **Repeater** (gaps / tips / size / center)
...
[Answer]: decrease the width of arrows in repeater it should match the watch of condition arrows and edge tip arrows should be same as the arrows in condition
