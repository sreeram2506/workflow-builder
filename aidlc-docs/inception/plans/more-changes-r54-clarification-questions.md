# More Changes R54 — Clarification Questions (change request)

**Context**: You requested changes after U1–U9 closed (including Logic Node Properties) and earlier R53 polish (Templates footer removed; name ellipsis).  
...
B) **Logic node Properties** (fields, connector panel, validation, save)

C) **Nodes Library** (featured strip / Blank Agent / search / scroll / drag)
