# More Changes R23 — Clarification Questions (change request)

**Context**: You requested changes after R22 (Properties toggle icon left of title; Export/Import icons).  
...
A) **Sidebar open/close / chrome** (Nodes Library or Properties)

B) **Theme toggle**

C) **Top bar** (Export / Import icons, Save, Run, Reset, etc.)

D) **Undo / redo / Layout / zoom / minimap**

E) **Connection rules / edges / handles / node visuals**
