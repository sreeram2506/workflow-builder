# More Changes R39 — Clarification Questions (change request)

**Context**: You requested changes after R38 (Repeater `->` tip; arc meets wing notch; gap on other side).  
...
A) **Repeater** (center / tip / gap / size)
...
[Answer]: i will share one image for repeater make changes same to that shape but don't change color
