# More Changes R53 — Clarification Questions (change request)

**Context**: You requested more changes after R52 (featured strip drag matches category cards).  
...
B) **Condition / Router shapes** (geometry / glyph / handles)

C) **Nodes Library** (featured shapes / Blank Agent / search / scroll / drag)

D) **Top bar / undo / layout / zoom / minimap / sidebar chrome / resize**
...
```text
1.Remove templates footer in nodes library 
2.What if node name is too long in nodes library ellipsis is there ?
```
