# More Changes R47 — Clarification Questions (change request)

**Context**: You requested changes after R46 (Router outer shape → octagon).  
...
A) **Repeater** (stroke / tips / gaps / size / handles / shape)

B) **Condition / Router shapes** (geometry / octagon / handles / glyph)
...
[Answer]: the shape for router might be different from others but it doesn't suits for router keep something good and add also add that inside shapes of router repeater and conditionin the left menu of node library
