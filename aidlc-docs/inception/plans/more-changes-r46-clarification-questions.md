# More Changes R46 — Clarification Questions (change request)

**Context**: You requested changes after R45 (Repeater/Router shapes flush to connection handles).  
...
B) **Condition / Router shapes** (geometry / handles / flush)
...
[Answer]: change the outer shape for router keep something that will suits for router
