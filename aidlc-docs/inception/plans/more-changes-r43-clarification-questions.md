# More Changes R43 — Clarification Questions (change request)

**Context**: You requested changes after R42 (Repeater stroke matched to Condition `2.4`).  
...
A) **Repeater** (stroke width / tips / gaps / size / center / overall shape)

B) **Condition / Router shapes**

C) **Sidebar open/close / chrome**

D) **Top bar / undo / layout / zoom / minimap**
...
[Answer]: A — decrease the width of arrows in repeater it should match the width of condition arrows and edge tip arrows should be same as the arrows in condition
...
```text
- Repeater stroke width = Condition (2.4)
- Repeater tip arrows = Condition-style chevrons (screenshot of tip shape attached)
```
