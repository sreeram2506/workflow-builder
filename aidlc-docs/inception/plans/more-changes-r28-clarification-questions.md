# More Changes R28 — Clarification Questions (change request)

**Context**: You requested changes after R27 (card-theme SVG fills; corrected diamond / hexagon / rounded-square shapes).  
...
A) **Condition / Router / Repeater shapes** (size, icon, color, label, ports)
...
[Answer]: Arrows are not set properly for condition and repater svgs set them properly
