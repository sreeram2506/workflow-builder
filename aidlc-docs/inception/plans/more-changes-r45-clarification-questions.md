# More Changes R45 — Clarification Questions (change request)

**Context**: You requested changes after R44 (Repeater tip placement; filled-triangle tip change was reverted).  
...
[Answer]: there is some sapce between connecting circles and outer shape of repeater and router attach them like other nodes
