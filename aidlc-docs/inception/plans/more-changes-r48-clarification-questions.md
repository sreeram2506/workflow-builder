# More Changes R48 — Clarification Questions (change request)

**Context**: You requested changes after R47 (Router pointed hexagon + library shape previews).  
...
C) **Nodes Library** (shape previews / icons / layout)

D) **Top bar / undo / layout / zoom / minimap / sidebar chrome**
...
[Answer]: can you make the shapes of nodes libarary a little larger
